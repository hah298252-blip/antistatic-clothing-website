  ...
  useGSAP(
    () => {
      ...
      const splitInstance = new GSAPSplitText(el, {
        ...
        onSplit: self => {
          assignTargets(self);
          // Allow a parent scroll scene to own the tween while this component
          // still handles the reliable GSAP character splitting.
    ...
    },
    {
      dependencies: [
        ...
        threshold, rootMargin, fontsLoaded, manual,
      ],
      scope: ref,
    }
  );
